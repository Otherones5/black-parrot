...
module bsg_mem_1rw_sync_mask_write_bit #(parameter width_p=-1
  ...
  // Used for 64 KB cache (tag mem, icache stat mem, dcache stat mem)
  `bsg_mem_1rw_sync_mask_write_bit_macro (496,32) else
  `bsg_mem_1rw_sync_mask_write_bit_convert_macro (15,16,1,32) else
  `bsg_mem_1rw_sync_mask_write_bit_convert_macro (31,32,1,32) else
  // Used for 32 KB cache (tag mem, icache stat mem, dcache stat mem)
  ...
  // Used for 16 KB cache (tag mem, icache stat mem, dcache stat mem)
  `bsg_mem_1rw_sync_mask_write_bit_convert_macro (124,128,4,128) else
  `bsg_mem_1rw_sync_mask_write_bit_convert_macro (3,8,5,128) else
  `bsg_mem_1rw_sync_mask_write_bit_convert_macro (7,8,1,128) else
